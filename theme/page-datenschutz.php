    ...
    <div class="container">
        <article class="single-post">
            ...
            <div class="post-content">
                ...
                <h3>Goneo</h3>
                <p>
                    Anbieter ist die Goneo Internet GmbH, Bouchéstraße 12, Haus 11, 12435 Berlin (nachfolgend "Goneo").
                </p>
                <p>
                    Details entnehmen Sie der Datenschutzerklärung von Goneo: 
                    <a href="https://www.goneo.de/datenschutz/" target="_blank" rel="noopener noreferrer">https://www.goneo.de/datenschutz/</a>
                </p>
                <p>
                    Die Verwendung von Goneo erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein 
                ...
                <p>
                    E-Mail: info(at)k4l1um.de<br>
                    Telefon: +49 171 1859808
                </p>
                <p>
                ...
                <p class="legal-notice" style="margin-top: 40px; padding: 20px; background: rgba(41, 171, 226, 0.1); border-left: 3px solid #29abe2;">
                    <strong>Hinweis:</strong> Diese Website verwendet derzeit keine Analyse-Tools wie Google Analytics 
                    oder ähnliche Dienste. Sollten solche Dienste zukünftig eingesetzt werden, wird diese 
                ...
                <p>
                    ...
                    Inhalte bestehen oder datenschutzrelevante Fragen aufkommen, kontaktieren Sie uns bitte unter den im 
